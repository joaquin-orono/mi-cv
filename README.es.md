...
### Founder & Product Manager — [Mind One](https://www.getmindapp.io) y [Qontexta.ai](https://qontexta.ai)
`2025 – Actualidad`
...
**Mind** es mi propio laboratorio de conocimiento práctico — mi base para mantenerme a la vanguardia, probar las soluciones más nuevas del mercado y convertirlas en formas reales de llevar la IA a las organizaciones. 12+ años con autonomía total liderando transformaciones de datos end-to-end en travel, banca, retail, hostelería e industria; en los últimos años, arquitecturas listas para IA y adopción real de LLMs.
...
Cuadro de Mando Integral corporativo de principio a fin con **300+ KPIs** en ~20 dashboards (OBIEE, SQL Server, Essbase). Reporte a CIO y CFO.
**Resultado →** De Excel manual a gestión del rendimiento centralizada y automatizada.

</td>
<td width="50%" valign="top">

**Caixa Penedés** · Banca · `2005/2010`
*ETL Developer*

Data Warehouse comercial con modelo snowflake para análisis de margen de cliente (Oracle Warehouse Builder + Business Objects), integrado después en el core del banco.
**Resultado →** Analítica comercial adoptada en los sistemas core del banco.
...
Plataforma Big Data Hortonworks integrando SAP, Oracle y sistemas operacionales, con QlikView como BI transversal.
**Resultado →** Vista consolidada end-to-end de operaciones y finanzas.
...
Rollout global de BI OBIEE (TME) a **6.500+ usuarios** en Europa, EE. UU. y Sudeste Asiático.
**Resultado →** BI corporativo estandarizado en 3 continentes, reemplazando herramientas legacy.
...
Arquitectura big data serverless en GCP + Power BI con ML sobre SAP HANA Cloud, Magento y SQL.
**Resultado →** Forecasting, segmentación e inventario optimizado en producción.
...
- **Banque Misr Digital** · Banca · `2021` — *Big Data Solution Architect.* Plataforma en tiempo real sobre Cloudera con Kafka + Flink, DWH Impala y HBase/Phoenix. **Resultado:** operaciones bancarias y analítica en tiempo real sobre 25 fuentes unificadas.
